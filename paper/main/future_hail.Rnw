...
events within the broad cropping season strongly influences possible crop damage
...
(Supplementary Figure \ref{SM-fig:historical_all_proxies} \todo{and changes}).
