"""Calculate hail proxies for ERA5 data."""
...
heights_file = '/g/data/up6/tr2908/future_hail_global/orography/era5_surface_height.nc' # Surface heights file.
...
heights = xarray.open_dataset(heights_file).z

if not os.path.exists(outfile):
    dat = xarray.open_mfdataset(f'{base_dir}/*conv*.nc', parallel=True)
    dat['surface_height'] = heights
    ...
    prox['proxy_Raupach2023_original'] = up.apply_Raupach_proxy(
        dat=dat,
    ...
    prox['proxy_Raupach2023_original_noconds'] = up.apply_Raupach_proxy(
        dat=dat,
        results_file=proxy_results_file,
