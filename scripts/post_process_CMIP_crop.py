...
outdir = '/g/data/up6/tr2908/future_hail_global/CMIP_conv_crop_stats' # Processing output directory.
out_res = 1                                                           # Output resolution (degrees).

# Command line arguments.
assert len(sys.argv) == 6, 'Usage: post_process_CMIP_crop.py <epoch_name> <model_name> <start_year> <end_year>'
...
if os.path.exists(out_file):
    ...
    # Process epoch.
    stats = fh.process_epoch_crop(epoch_name=epoch_name,
                                  exp=exp,
